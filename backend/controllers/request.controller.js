...
export const postRequest = async (req, res) => {
    try {
        const { title, description, address, salary, department, location } = req.body; // Removed 'requirements'
        const userId = req.id;

        if (!title || !description || !address || !salary || !location || !department) { // Fixed validation

...
const Footer = () => {
  return (
    <footer className="w-full backdrop-filter backdrop-blur-md bg-white bg-opacity-40 border-t border-t-gray-200 rounded-2xl py-7 backdrop-blur-md shadow-t-5xl">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">EasyRTI</h2>

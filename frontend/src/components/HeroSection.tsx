    ...
    <div className="text-center">
      <div className="flex flex-col gap-5 my-10">
        ...
        <h1 className="text-5xl font-bold">
          Request Your
          <br />
          New <span className="text-5xl font-semibold bg-gradient-to-br from-orange-500 via-orange-100 via-neutral-100 to-emerald-500 bg-clip-text text-transparent font-script drop-shadow-sm">RTI</span>
        </h1>
        <div className="text-2xl flex justify-center gap-3">On Departments @
          <span className="font-semibold bg-gradient-to-br from-orange-500 via-orange-100 via-neutral-100 to-emerald-500 bg-clip-text text-transparent font-script drop-shadow-sm">
            <Typewriter
              options={{
                strings: ['Finance', 'Health', 'Election Commission', 'Transport', 'Environment', 'Education', 'Housing', 'Agriculture'],
                autoStart: true,
                loop: true,
                deleteSpeed: 30,
              }}
        ...
        <div className='flex w-[40%] shadow-lg border border-gray-200 pl-3 rounded-full items-center gap-4 mx-auto'>
                    ...
                    />
                    <Button onClick={searchRequestHandler} className="rounded-r-full bg-[#1caa76]">
